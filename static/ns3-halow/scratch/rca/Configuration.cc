...
Configuration::Configuration(int argc, char *argv[]) {
    ...
    cmd.AddValue ("txCurrent", "number of RAW groups", txCurrent);
    cmd.AddValue ("rxCurrent", "number of RAW groups", rxCurrent);
    cmd.AddValue ("idleCurrent", "number of RAW groups", idleCurrent);
