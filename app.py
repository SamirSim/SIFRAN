...
def _check_form(form, messages_error):
    valid = True
    print("Submitted")
...
def index():
    ...
    if request.method == "POST":
        print("Submitted")
        valid = _check_form(form, messages_error)
        if valid:
            ...
            try:
                ...
                if (network == 'LoRaWAN'):
                    ...
                    densities = [i for i in range(int(session['number_devices']), int(session['max_number_devices']))]
